...
function Sidebar() {
  ...
  return (
    <>
      <div className="text-white text-2xl top-7 left-10 items-center cursor-pointer" onClick={handleClick}>
        {isOpen ? <IoClose/> : <RxHamburgerMenu/>}
      </div>

      {isOpen &&
      
        <div className="bg-black flex flex-col items-center p-2 top-0 left-20 transition-all ease-in-out">
